...
<body>
	...
	include('mysqli_connect.php');
		...
		echo '<tr><th>Book Name</th><th>Picture</th><th>Price</th><th>Description</th><th>Add To Shopping Cart</th></tr>';
		...
		while($row = mysqli_fetch_array($rows,MYSQLI_ASSOC)){
			...
			echo "<tr><td>".$BookName.'</td><td><a href="#"><img src="Pics/'.$BookID.'.jpg" alt="book" height="150" width="120"/></a></td><td>$'.$Price.'</td><td>'.$Description.'</td><td><a href="#0" class="add" onclick="AddToCart()">Add</a></td></tr>';
		}
		echo '</table>';
		mysqli_close($dbc);	
	?>	
