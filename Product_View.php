...
<head>
	...
	<link href="includes/addtocart.css" type="text/css">
</head>
...
<body>
	...
	if(isset($_SESSION['username'])){
		...
		while($row = mysqli_fetch_array($rows,MYSQLI_ASSOC)){
			...
			echo '<button type="submit" class="add"/>AddToCart</button></form></td></tr>';
		}
		echo '</table>';
		mysqli_close($dbc);	
	}
	...
	<script type="text/javascript" color="0, 204, 0" pointColor="102, 255,153" opacity='0.7' count="99" src="particle/canvas-nest.js"></script>		
</body>
</html>
