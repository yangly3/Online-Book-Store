...
<html>
	...
	<body>
        ...
        <nav class="dropdownmenu">
          	<ul>
               <li><a href="1tDisplay_Product.php">Home</a></li>               
		...
		<form method="GET" action="1tDisplay_Product.php">
	...
	<div id="table">
		...
		<?php
			...
			echo "THE USER LOGGED IN IS: ".$CurrentCustomer;
			...
			$q = "SELECT CustomerID FROM Customer WHERE CustomerName = '$CurrentCustomer'";
